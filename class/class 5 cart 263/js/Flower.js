class Flower {
    // function inside class (method) do not prefix with "function"
    constructor(x,y,size,stemLength,petalColor) { // special name for OOP object creation
