# *i gave my sim avatar top surgery, what does yours look like?* by Amélie Barrette / Nou Noune
> This project is a demo of how avatars can be used to express oneself. It uses libraries to guide the viewer towards the world of SimUlator, their bigger project with the same purpose.
> I was surprised by the fact that the interface was reduced to only a tiny window in which the user could interact, but I found the controls easy to understand.
> The concept behind the work is clear and well communicated: the work feels personal while also clearly pointing to universal principles (i.e., self-expression).
> Aesthetically, the house environment is simple and clean. The side to side and forwards/backwards movement works well to not make the user feel too disoriented.
> I would have liked to be able to customize my own avatar, but I understand that this is beyond the scope of this project.
> The music and avatars very much anchor this world as an extension of The Sims, but it feels like a "hack" or "mod", which is interesting in terms of creating its own world beyond the game.

# *Digi Chiika (デジ ちいか)* by Ash Oest O’Leary & Elle Lilin Kyuss Lim-Fauteux
> Ash and Elle's project is a web game, which consists of raising and playing with a Tamagotchi.
...
# *Interactive Bike Garage* by Émile Bédard
> Émile's project is a web experience/service for bikers to record their bikes and bike parts, and easily access information pertaining to bike repairs - this remains the same from his Project 1 I reviewed earlier in the course.
> Émile uses 3D in a very interesting way: he creates a world that extends the viewer's, a world that becomes a virtual room in one's house.
